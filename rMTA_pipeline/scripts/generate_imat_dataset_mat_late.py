...
omics_data = pd.read_csv('later_onset_expression.tsv', sep="\t",  index_col=0)
...
import scipy.io
scipy.io.savemat('expressionData_imat_late.mat', data)
print("Expression data saved to expressionData_imat_late.mat")
